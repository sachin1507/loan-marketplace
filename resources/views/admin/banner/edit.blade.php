          ...
          <div class="col-md-6">
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">@lang('admin.banners.edit_banner')</h3>
              </div>
              ...
              <div class="box-body">        
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{!! $banner->name !!}" class='form-control' placeholder='Name' required />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{!! $banner->title !!}" class='form-control' placeholder='Title' required />
                    <p class="help-block"></p>
                    @if($errors->has('title'))
                        <p class="help-block">
                            {{ $errors->first('title') }}
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sub_title" value="{!! $banner->sub_title !!}" class='form-control' placeholder='Sub Title' required />
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" cols="" rows="10" id="description" placeholder='Description' required>{!! $banner->description !!}</textarea>
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="button_text" value="{!! $banner->button_text !!}" class='form-control' placeholder='Button Text' required />
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="button_link" value="{!! $banner->button_link !!}" class='form-control' placeholder='Button Link' required />
                    <p class="help-block"></p>
