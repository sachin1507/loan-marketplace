          ...
          <div class="col-md-12">
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">@lang('admin.products.edit_product')</h3>
              </div>
              <form method="POST" action="{{ route('admin.product.update', $article->id) }}" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sub_title" value="{{ $article->sub_title }}" class='form-control' placeholder='Sub Title' />
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <select name="subcat_id" class="form-control" required>
                     @foreach($subcategories as $subcategory)
                        @if($subcategory->id == $article->subcat_id)
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title1" value="{{ $article->title1 }}" class='form-control' placeholder='Title 1' />
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="content1" cols="" rows="3" id="content1" placeholder='Content 1'>{{ $article->content1 }}</textarea>
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title2" value="{{ $article->title2 }}" class='form-control' placeholder='Title 2' />
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="content2" cols="" rows="3" id="content2" placeholder='Content 2'>{{ $article->content2 }}</textarea>
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title3" value="{{ $article->title3 }}" class='form-control' placeholder='Title 3' />
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="content3" cols="" rows="3" id="content3" placeholder='Content 3'>{{ $article->content3 }}</textarea>
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="button_link" value="{{ $article->button_link }}" class='form-control' placeholder='Button Link' required />
                    <p class="help-block"></p>
